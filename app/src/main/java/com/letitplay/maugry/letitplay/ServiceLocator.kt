...
object ServiceLocator {
    ...
    private val trackRepository: TrackRepository by lazy { TrackDataRepository(db, serviceImpl, postServiceImpl, putServiceImpl, deleteServiceImpl, schedulerProvider) }
